  ...
  <div class="counter-warp">
    <div class='top'>
      <!--轮播图地址 和搜索-->
        ...
        <van-cell title="优惠券" :border='false' value="100.00"/>
...
.footer{header:50px; background:#f8f8f8}
...
.address{
  ...
  .topimg{ background-image: -webkit-linear-gradient(left, #fc7964, #ff4943);display:flex;color:#fff ;height:3rem;line-height:3rem;}
  .topimg span{width:60%;padding-left:10%}
  .topimg img{width:20%;padding-right:10%;height:1.4rem;margin-top:0.8rem}
.footer{display:flex;justify-content:flex-end;padding:10px 0}
.footer p{padding:5px 10px;font-size:14px;margin:0 5px;border:1px solid #f1f1f1;border-radius:6px}
</style>
