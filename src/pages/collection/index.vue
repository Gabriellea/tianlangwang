...
.jiazaigengduotxt{
 ...
 .xiaoliang{font-size:12px;color:#474747;line-height:20px;display:flex;justify-content: space-between}
 .del{color:#989898;padding:0 10px;border:1px solid #f1f1f1;border-radius:10px}
</style>
