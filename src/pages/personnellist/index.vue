<template>
  <div class="counter-warp">
    <div class='list'>
      <div class='left'>
        <img src='/static/images/headerimg.png'>
        <span>用户名称</span>
      </div>
      <span class='fontcolor'>2018-08-20</span>
    </div>
    <div class='list'>
      <div class='left'>
        <img src='/static/images/headerimg.png'>
...
.header_left img{width:1.2rem;height:1.2rem} 
.username{
...
.list{background:#fff;font-size:14px;padding:20px 15px 20px;height:20px;border-bottom:1px solid #f1f1f1}
.bianji{width:60px;float:left;height:20px;line-height:20px}
.list img{width:40px;height:40px;margin:-10px 10px 0 10px;float:left}
