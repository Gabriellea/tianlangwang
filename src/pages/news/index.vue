...
.list{width:90%;margin:0 5% 0;}
.cont{background:#fff;padding:0 10px 10px;font-size:14px;border-radius:5px}
.listcont{display:flex;}
.title{line-height:30px;}
.listcont img{width:1rem;height:1rem;padding-right:10px;}
.listcont p{width:calc(100% - 1rem);color:#838383;}
.time{font-size:10px;color:#fff;background:#bababa;float:right;padding:4px 10px;margin-top:10px;border-radius:5px}
.read{width:8px;height:8px;background:red;border-radius:50%;float:right}
.jiazaigengduo{
margin:0 45%;
width:10%;
