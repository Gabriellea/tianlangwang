<template>
  <div class="counter-warp">
    <div class='header'>
      ...
      <div class='header_left'>
        ...
        <div class='username'>
          ...
          <p style='font-size:14px'>所属店铺内容描述内容</p>
        </div>
    ...
    <div class='fenxiao'>
      <div class='fenxiao_item'  @click="$go('distribution',{active:'0'})" >
         <img src='/static/images/wd_6.png'>
          <div style='padding:8px;'>
            <p >我的分销</p>
            <p style='color:#26a1fa '>10人</p>
          </div>
          
      </div>
      <div class='fenxiao_item' style='border-left:1px solid #dadada'  @click="$go('distribution',{active:'1'})" >
          <img src='/static/images/wd_7.png'>
          <div style='padding:8px '>
            <p>我的佣金</p>
            <p style='color:#ff5e49'>10人</p>
          </div>
      </div>
    ...
    <button class='btn' @click="$go('apply')" >申请成为分销商</button>
